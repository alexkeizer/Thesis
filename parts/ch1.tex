...
Coq, yet another theorem prover, is also based on this same calculus, but interestingly provides support
for coinductive types directly in the language~\cite{gimenezApplicationCoinductiveTypes1996,gimenezTutorialRecursiveTypes1998}.
