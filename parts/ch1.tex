...
for coinductive types and corecursion directly in the trusted kernel~\cite{gimenezApplicationCoinductiveTypes1996,gimenezTutorialRecursiveTypes1998}. Contrast this with the BNF or QPF approaches, which are implemented entirely as a
library.

The study of coinduction 
