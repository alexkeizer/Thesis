...
Note that parser extensions are not strictly about which syntax is \emph{supported}, rather, they declare which syntax this command is \emph{responsible} for.
...
Where \lean{declration} is the name of the parser we defined in the preceding section, telling Lean
