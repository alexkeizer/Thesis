...
These conversions were implemented as \leanm{TypeFun.toCurried} and \leanm{TypeFun.ofCurried}, respectively, and it was proven that these functions are inverses. 
...
One should be able to lift \lean{β} into the right universe, but functions without arguments are not particularly interesting for our purposes anyway, so a simpler solution was chosen. 
